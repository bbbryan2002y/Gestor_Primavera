 ...
 ?>
  ...
  if(isset($_GET["modifico"])) {
    ...
    <div class="w3-panel w3-blue w3-display-container">
      ...
      <p>Se actualizo la informacion correctamente</p>
    </div>
    <?php
        }
  ?>
  ...
  if(isset($_GET["borro"])) {
    ...
    <div class="w3-panel w3-red w3-display-container">
      ...
      <p>Se borro la informacion correctamente</p>
    </div>
    <?php
        }
  ?>
...
<div class="w3-col" style="width:90%">
  <h3><center>Directorio T.I</center></h3>
    <div class="w3-container">
      <br>
        ...
        <br>
        <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-block w3-green w3-round-large">Nuevo registro</button>
        <br>
        </div>
        <br>
...
<table class="w3-table-all w3-card-4 " id="datos">
  ...
  $resultado_consulta_mysql = mysqli_query($conexion, "SELECT * FROM `directorio_ti`");

    while ($row = mysqli_fetch_assoc($resultado_consulta_mysql)){
  ?>
<tr>
<td><?php echo $row['iddir_ti']?></td>
...
<td><a href="editardir.php?id=<?php echo $row['iddir_ti']; ?>" class="w3-btn w3-blue w3-round-xlarge">Editar</a></td>
<td><a href="fx/borrar_dir_ti.php?id=<?php echo $row['iddir_ti']; ?>" onclick="return confirmar()" class="w3-btn w3-red w3-round-xlarge">Borrar</a></td>
