	...
	<h3><center>Inicio de sesion de todos los usuarios</center></h3>
		<div class="w3-container">
			<br>
				...
				<input type="date" name="buscar" placeholder="Buscar..." id="searchTerm" class="w3-input w3-border"  onclick="doSearch()">
                ...
                <div class="w3-container w3-half ">
                  ...
                  <option value="<?php echo $rows['regusu']?> "><?php echo $rows['regusu'] ?>
                  </option>
...
<table class="w3-table-all" id="datos">
  ...
  <?php
  $regusu=$_POST['usu'];
  $resultado_consulta_mysql = mysqli_query($conexion, "SELECT * FROM `regingreso` WHERE `regusu` ='$regusu' ORDER BY Fecha DESC");
